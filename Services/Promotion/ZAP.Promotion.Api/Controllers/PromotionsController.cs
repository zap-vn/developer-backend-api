...
using ZAP.Promotion.Application.Features.Promotions.Commands;
using ZAP.Promotion.Application.Features.Promotions.Queries;
using ZAP.Promotion.Application.Features.Promotions.DTOs;

namespace ZAP.Promotion.Api.Controllers
{
    [ApiController]
    ...
    public class PromotionsController : ControllerBase
    {
        ...
        {
            return Ok(new { Status = "ZAP Promotion API is running", Time = System.DateTime.UtcNow });
        }
