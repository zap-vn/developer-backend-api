...
using ZAP.Payment.Application.Features.PaymentTypes.Commands;
using ZAP.Payment.Application.Features.PaymentTypes.Queries;
...
namespace ZAP.Payment.Api.Controllers
{
    ...
    public class PaymentTypesController : ControllerBase
    {
        ...
        {
            return Ok(new { Status = "ZAP PaymentTypes API is running", Time = System.DateTime.UtcNow });
        }
