...
using ZAP.Product.Application.Features.Products.Commands;
using ZAP.Product.Application.Features.Products.Queries;
...
namespace ZAP.Product.Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            return Ok(new { Status = "ZAP Product API is running", Time = System.DateTime.UtcNow });
        }
