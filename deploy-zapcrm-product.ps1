# Deploy zapcrm Product API to Google Cloud Run
# Project: zapcrm-492101

$projectName = "zapcrm-492101"
$region = "asia-southeast1"
$serviceName = "zapcrm-product-api"
$repoName = "crm-repo"
$imageTag = "latest"
$imageName = "asia-southeast1-docker.pkg.dev/$projectName/$repoName/${serviceName}:$imageTag"

Write-Host "🚀 Starting Deployment of zapcrm-product-api to Google Cloud Run..." -ForegroundColor Green
...
gcloud builds submit --config cloudbuild.zapcrm-product.yaml .
